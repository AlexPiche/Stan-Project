...
namespace bnn_ard_model_namespace {
    ...
    try {
        {
            ...
            for (int i = 1; i <= rows(X); ++i) {
                ...
                for (int j = 1; j <= cols(X); ++j) {
                    ...
                    stan::math::assign(get_base1_lhs(res,i,j,"res",1), tanh(get_base1(X,i,j,"X",1)));
                }
            }
...
class bnn_ard_model : public prob_grad {
private:
    int N;
    int d;
    int num_nodes;
    ...
    int num_layers;
public:
    bnn_ard_model(stan::io::var_context& context__,
        std::ostream* pstream__ = 0)
        : prob_grad(0) {
        current_statement_begin__ = -1;

        static const char* function__ = "bnn_ard_model_namespace::bnn_ard_model";
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            for (int i = 1; i <= (num_nodes * d); ++i) {
                ...
                stan::math::assign(get_base1_lhs(one_over_sqrt_phi,i,"one_over_sqrt_phi",1), sqrt(get_base1(phi,i,"phi",1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
        ...
        try {
            {
                ...
                lp_accum__.add(gamma_log<propto__>(phi, 1, 1));
                current_statement_begin__ = 95;
                lp_accum__.add(normal_log<propto__>(to_vector(beta_output), 0, 1));
                current_statement_begin__ = 96;
                lp_accum__.add(normal_log<propto__>(to_vector(beta_first), 0, multiply(sigma,one_over_sqrt_phi)));
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "bnn_ard_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
...
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
        ...
        vector_d alphat(Nt);
        (void) alphat;  // dummy to suppress unused var warning
        vector_d alpha(N);
        (void) alpha;  // dummy to suppress unused var warning
        ...
        stan::math::fill(alphat,DUMMY_VAR__);
        stan::math::fill(alpha,DUMMY_VAR__);

        try {
            current_statement_begin__ = 107;
            stan::math::assign(alphat, calculate_alpha(Xt,bias,beta_first,beta_middle,beta_output, pstream__));
            current_statement_begin__ = 108;
            for (int i = 1; i <= Nt; ++i) {
                current_statement_begin__ = 109;
                stan::math::assign(get_base1_lhs(predictions,i,"predictions",1), inv_logit(get_base1(alphat,i,"alphat",1)));
                current_statement_begin__ = 110;
                stan::math::assign(get_base1_lhs(errors,i,"errors",1), fabs((get_base1(yt,i,"yt",1) - round(get_base1(predictions,i,"predictions",1)))));
            }
            current_statement_begin__ = 112;
            stan::math::assign(average_error, BER(yt,predictions,Nt, pstream__));
            current_statement_begin__ = 113;
            stan::math::assign(alpha, calculate_alpha(X,bias,beta_first,beta_middle,beta_output, pstream__));
            current_statement_begin__ = 114;
            for (int n = 1; n <= N; ++n) {
                current_statement_begin__ = 115;
                stan::math::assign(get_base1_lhs(log_lik,n,"log_lik",1), bernoulli_logit_log(get_base1(y,n,"y",1),get_base1(alpha,n,"alpha",1)));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e,current_statement_begin__);
            // Next line prevents compiler griping about no return
throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (int k_0__ = 1; k_0__ <= Nt; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "alphat" << '.' << k_0__;
            param_names__.push_back(param_name_stream__.str());
        }
        for (int k_0__ = 1; k_0__ <= N; ++k_0__) {
            param_name_stream__.str(std::string());
...
typedef bnn_ard_model_namespace::bnn_ard_model stan_model;
